...
{
    // $.ajax({
    //     url: site_url + "uac/modules/update",
    //     type: "POST",
    //     data: $("#form-module-detail").serialize(),
    //     dataType: "json",
    ...
    var form = $('#form-module-detail')[0];
    var data = new FormData(form);

    $.ajax({
        type: "POST",
        enctype: 'multipart/form-data',
        url: site_url + "uac/master/modules/update",
        data: data,
        dataType: "json",
        cache : false,
        contentType: false,
