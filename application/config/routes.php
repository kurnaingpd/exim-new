...
$route['export/packing/item_by_category'] = 'Packing/item_detail_by_category';
$route['export/packing/item_by_category/(:num)/(:num)'] = 'Packing/item_detail_by_category/$1/$2';
