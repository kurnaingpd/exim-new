...
$route['export/packing/category/(:num)/(:any)'] = 'Packing/category/$1/$2';
$route['export/packing/item'] = 'Packing/item';
$route['export/packing/item/(:num)'] = 'Packing/item/$1';
$route['export/packing/item/(:num)/(:any)'] = 'Packing/item/$1/$2';
$route['export/packing/item/(:num)/(:any)/(:num)'] = 'Packing/item/$1/$2/$3';
...
$route['export/packing/detail_category/(:num)/(:any)'] = 'Packing/detail_category/$1/$2';
$route['export/packing/detail_item'] = 'Packing/detail_item';
$route['export/packing/detail_item/(:num)'] = 'Packing/detail_item/$1';
$route['export/packing/detail_item/(:num)/(:any)'] = 'Packing/detail_item/$1/$2';
$route['export/packing/detail_item/(:num)/(:any)/(:num)'] = 'Packing/detail_item/$1/$2/$3';
