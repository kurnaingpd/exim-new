            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group required">
                        ...
                        <input type="text" name="branch" class="form-control upper" id="branch" placeholder="Enter branch" autocomplete="off" required value="<?=$params['detail']->branch?>">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group required">
                        ...
                        <textarea type="text" name="address" class="form-control upper" id="address" placeholder="Enter address" autocomplete="off" rows="3" required><?=$params['detail']->address?></textarea>
                    </div>
                </div>
            </div>
