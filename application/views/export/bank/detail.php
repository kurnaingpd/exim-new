            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group required">
                        ...
                        <input class="form-control upper" id="branch" name="branch" placeholder="Enter bank branch" autocomplete="off" required value="<?=$params['detail']->branch?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group required">
                        ...
                        <textarea name="address" class="form-control upper" id="address" placeholder="Enter bank address" required rows="3"><?=$params['detail']->address?></textarea>
                    </div>
                </div>
            </div>
