    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="card">
                ...
                <div class="card-body overflow-auto" style="max-height: 720px; overflow-x: hidden;">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php $this->load->view('export/proforma/edit/consignee'); ?>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php $this->load->view('export/proforma/edit/beneficiary'); ?>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php $this->load->view('export/proforma/edit/data'); ?>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php $this->load->view('export/proforma/edit/items'); ?>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php $this->load->view('export/proforma/edit/summary'); ?>
                        </div>
                    </div>
                </div>
            </div>
