    ...
    <div class="col-md-4">
        <div id="required" class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control cpship" id="cpshipto_phone" name="cpshipto_phone" placeholder="Enter phone number" autocomplete="off" pattern="^[0-9+]+$" value="<?=($params['cust_cpship']?$params['cust_cpship']->phone_no:'-')?>">
            </div>
        </div>
    </div>
