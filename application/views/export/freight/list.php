<div class="card">
    ...
    <div class="card-body">
        <table id="tfreightlist" class="table table-sm table-bordered table-striped">
            <thead>
            ...
            <tbody>
                <?php $no=1; foreach($params['list'] as $rows) : ?>
                    <tr class="align-middle">
                        ...
                        <td><?=$rows->company?></td>
                        <td class="text-center"><?=$rows->contact?></td>
                        <td class="text-center"><?=$rows->number?></td>
                        <td class="text-center"><?=$rows->created_at?></td>
                        <td class="text-center"><?=($rows->updated_at?$rows->updated_at:'-')?></td>
                        <td class="text-center">
                            <a href="<?=site_url('export/freight/detail/'.$rows->id)?>" class="btn btn-sm btn-info">
