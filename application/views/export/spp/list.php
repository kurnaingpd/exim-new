<div class="card">
    ...
    <div class="card-body">
        <table id="tspplist" class="table table-sm table-bordered table-striped">
            <thead>
                <tr class="text-center">
                    <th>#</th>
                    <th>Product statement letter no.</th>
                    <th>Invoice no.</th>
                    <th>Created at</th>
                ...
                <?php $no=1; foreach($params['list'] as $rows) : ?>
                    <tr class="align-middle">
                        ...
                        <td class="text-center">
                            <a href="<?=site_url('export/spp/print/'.$rows->id)?>" class="btn btn-sm btn-warning" target="_blank">
