<div class="row">
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="cons_company" placeholder="Enter company name" disabled>
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="cons_country" placeholder="Enter country" disabled>
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="cons_cp" placeholder="Enter attention contact person" disabled>
        </div>
    </div>
</div>