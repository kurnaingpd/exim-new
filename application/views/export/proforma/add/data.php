<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group required">
            ...
            <select name="destination_port" class="form-control select2bs4" id="destination_port" required>
                <option></option>
                <?php foreach($params['load_port'] as $rows) : ?>
                    <option value="<?=$rows->id?>"><?=$rows->name?></option>
                <?php endforeach; ?>
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group required">
            ...
            <input type="text" name="freight_cost" class="form-control" id="freight_cost" placeholder="Enter freight cost" value="0" required>
        </div>
    </div>
    ...
    <div class="col-md-2">
        <div class="form-group required">
            ...
            <input type="text" name="insurance" class="form-control" id="insurance" placeholder="Enter insurance" value="0" required>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group required">
            ...
            <select name="top" class="form-control select2bs4" id="top" required>
                <option></option>
                <?php foreach($params['load_port'] as $rows) : ?>
                    <option value="<?=$rows->id?>"><?=$rows->name?></option>
                <?php endforeach; ?>
