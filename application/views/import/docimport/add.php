            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="shipment" class="form-control docs upper" id="shipment" placeholder="Enter shipment no" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="seller" class="form-control docs upper" id="seller" placeholder="Enter seller" autocomplete="off">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="hscode" class="form-control docs upper" id="hscode" placeholder="Enter hs code" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="lartas" class="form-control docs upper" id="lartas" placeholder="Enter lartas" autocomplete="off">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="container_no" class="form-control docs" id="container_no" placeholder="Enter container no." autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="goods_qty" class="form-control docs" id="goods_qty" placeholder="Enter goods qty" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="cbm" class="form-control docs" id="cbm" placeholder="Enter cbm" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="pol" class="form-control docs" id="pol" placeholder="Enter pol" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="pod" class="form-control docs" id="pod" placeholder="Enter pod" autocomplete="off">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="coo" class="form-control docs" id="coo" placeholder="Enter coo" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="masterlist" class="form-control docs" id="masterlist" placeholder="Enter masterlist" autocomplete="off">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <textarea name="remarks" class="form-control docs" id="remarks" placeholder="Enter remarks" autocomplete="off" rows="3"></textarea>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="duty" class="form-control docs percent landed_cost" id="duty" placeholder="Enter duty" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="vat" class="form-control docs" id="vat" placeholder="Enter vat" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="tax" class="form-control docs" id="tax" placeholder="Enter tax" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="freight_vat" class="form-control docs percent" id="freight_vat" placeholder="Enter freight" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="additional" class="form-control docs" id="additional" placeholder="Enter at cost" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="times" class="form-control docs" id="times" placeholder="Enter times" autocomplete="off">
                    </div>
                </div>
