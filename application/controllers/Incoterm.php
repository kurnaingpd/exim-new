    ...
    Class Incoterm extends CI_Controller
    {
        ...
        public function add()
        {
            $datas['js'] = [
                ...
                base_url("assets/adminlte/plugins/sweetalert/sweetalert.min.js"),
                base_url("assets/js/incoterm/add.js"),
            ];
            $datas['title'] = 'Export - Incoterm';
            $datas['breadcrumb'] = ['Export', 'Master', 'Incoterm'];
        ...
        public function save()
        {
            ...
            if($incoterm) {
                ...
                if($this->M_CRUD->insertData('master_incoterm', $param)) {
                    $response = ['status' => 1, 'messages' => 'Incoterm has been saved successfully.', 'icon' => 'success', 'url' => 'export/incoterm'];
                } else {
        ...
        public function detail($id)
        {
            $datas['js'] = [
                ...
                base_url("assets/adminlte/plugins/jquery-validation/additional-methods.min.js"),
                base_url("assets/adminlte/plugins/sweetalert/sweetalert.min.js"),
                base_url("assets/js/incoterm/detail.js"),
            ];
            $datas['title'] = 'Export - Incoterm';
            $datas['breadcrumb'] = ['Export', 'Master', 'Incoterm'];
            $datas['header'] = 'Detail record';
            $datas['params'] = [
                'detail' => $this->M_CRUD->readDatabyID('master_incoterm', ['is_deleted' => '0', 'id' => $id]),
            ];
        ...
        public function update()
        {
            ...
            // } else {
                ...
                if($this->M_CRUD->updateData('master_incoterm', $param, $condition)) {
                    $response = ['status' => 1, 'messages' => 'Incoterm has been updated successfully.', 'icon' => 'success', 'url' => 'export/incoterm'];
                } else {
        ...
        public function delete($id)
        {
            ...
            if($this->M_CRUD->deleteData('master_incoterm', $condition)) {
                $response = ['status' => 1, 'messages' => 'Incoterm has been deleted successfully.', 'icon' => 'success', 'url' => 'export/incoterm'];
            } else {
